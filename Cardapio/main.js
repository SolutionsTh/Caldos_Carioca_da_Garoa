...
function concluirPedido() {
    if (document.getElementById("pedidoCep").value != "") {
        ...
        document.getElementById("conteudoBotaoConcluirPedido").href = "https://wa.me/5511989182715?text=*Pedido*%0A*Sabor: *" + pedidoNome + pedidoTamanho + pedidoQuantidade + pedidoCep + pedidoRua + pedidoBairro + pedidoCidade + pedidoEstado + pedidoNumero + pedidoBloco + pedidoApartamento + pedidoReferencia;} else { window.alert("Favor, inserir um endereço para entrega!");
    }
}
function fecharPedido(){
    document.getElementById("conteudoCardapio").className = "conteudoCardapio";
    document.getElementById("conteudoPedido").className = "conteudoPedidoNone";
}